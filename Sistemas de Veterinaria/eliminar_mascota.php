...
try {
    ...
    header('Location: Mascotaspaginadas.php?tipo=exito&mensaje=' . urlencode('Mascota eliminada correctamente.'));
} catch (Throwable $e) {
    error_log($e->getMessage());
    header('Location: Mascotaspaginadas.php?tipo=error&mensaje=' . urlencode($e->getMessage()));
}
exit;
